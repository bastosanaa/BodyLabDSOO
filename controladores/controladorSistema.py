...
class ControladorSistema():
    def __init__(self):
        ...
        self.__controlador_matricula = ControladorMatricula(self.__controlador_aluno, self)
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.cadastra_professor, 2: self.cadastra_aluno, 3: self.cadastra_matricula, 4: self.cadastra_ficha}
